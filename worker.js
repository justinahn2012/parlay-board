...
export default {
  async fetch(req, env) {
    ...
    if (p === '/api/version') return J({
      build: '2026-09-08l', weeks: 22, slate: 'auto', lines: 'polymarket+espn',
