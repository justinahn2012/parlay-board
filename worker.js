...
export default {
  async fetch(req, env) {
    ...
    if (p === '/api/version') return J({ build: '2026-09-08e', weeks: 22,
      slate: 'auto', lines: 'polymarket+espn', seeded: false, agents: AGENTS.length });
    if (p === '/api/diag') {
